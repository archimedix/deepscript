...
> Il kingmaker della Silicon Valley: da Intel a Google e Amazon, il venture capitalist che ha plasmato l'era digitale

## Dati Essenziali

| Aspetto | Dettaglio |
|---------|-----------|
| **Nascita** | 29 giugno 1951, St. Louis, Missouri |
| **Nazionalita'** | USA |
| **Coniuge** | Ann Doerr |
| **Net Worth** | ~$12 miliardi (2023) |
...
| **2011-** | Council on Jobs and Competitiveness | Obama Administration |
| **2015-** | Board member | Obama Foundation |

### Investimenti Leggendari

| Azienda | Anno | Ruolo | Note |
|---------|------|-------|------|
| **Google** | 1999 | Lead investor, board | $12M → trilioni |
| **Amazon** | 1996 | Early investor, board | $8M → miliardi |
| **Netscape** | 1994 | Investor | Browser revolution |
| **Sun Microsystems** | 1982 | Investor | Workstation era |
| **Compaq** | 1982 | Investor | PC revolution |
| **Intuit** | - | Investor, board | Fintech pioneer |

### Momenti Chiave

| Anno | Evento |
|------|--------|
| **1974** | Entra in Intel, sviluppo microprocessore 8080 |
| **1980** | Entra in Kleiner Perkins (Grove: "non e' un vero lavoro") |
| **1999** | Investe $12M in Google, entra nel board |
| **2006** | Pioniere cleantech, California Global Warming Solutions Act |
| **2009** | Obama Economic Recovery Advisory Board |
| **2011** | Ospita "billionaires' dinner" per Obama con Jobs, Zuckerberg, Schmidt |
| **2015** | Entra nel board Obama Foundation |
| **2018** | Pubblica "Measure What Matters" (OKRs) |
| **2021** | Pubblica "Speed & Scale" (climate) |
| **2022** | Dona $1.1B a Stanford per Doerr School of Sustainability |
...
```
      ...
      |            |           |           |            |
      v            v           v           v            v
   KLEINER      ALPHABET    AMAZON      OBAMA        TECHNET
   PERKINS      (1999-)    (1996-10)   FOUNDATION   (founder)
  (1980-)        Board       Board      (2015-)
  Chairman
```
...
| **Fintech** | Intuit |
| **Hardware** | Sun, Compaq |
| **Cleantech** | Multiple dal 2006 |

### Network Professionale

| Nome | Connessione |
|------|-------------|
| [Larry Page](larry-page.md) | Backed at Google, board colleague |
| [Sergey Brin](sergey-brin.md) | Backed at Google |
...
| Evento | Partecipanti |
|--------|--------------|
| **2011 Billionaires' Dinner** | Larry Ellison, Steve Jobs, Mark Zuckerberg, Eric Schmidt, Reed Hastings, Carol Bartz, John Chambers, Dick Costolo, Art Levinson |

---

## Potere Esercitato

### Kingmaker della Silicon Valley

| Aspetto | Dettaglio |
|---------|-----------|
| **Google** | $12M investment → board seat → trillion-dollar company |
| **Amazon** | Early investor → shaped e-commerce |
| **OKRs** | Portato da Intel a Google, ora standard industria |
| **Jobs created** | Claim: oltre 1 milione |
...
| **2006-oggi** | Cleantech investments |
| **2021** | "Speed & Scale" - climate action plan |
| **2022** | $1.1B Stanford Doerr School of Sustainability |

### Political Influence

| Aspetto | Dettaglio |
|---------|-----------|
| **TechNet** | Co-founder, PAC per tech policy |
| **Obama advisor** | Economic Recovery Board, Jobs Council |
| **Obama Foundation** | Board member |
| **Fundraising** | Major Democratic donor |
...
John Doerr rappresenta:

1. **VC Kingmaker**: Ha creato le due aziende piu' potenti (Google, Amazon)
2. **Board power**: Siede nel board Alphabet dal 1999
3. **Political bridge**: Ponte Silicon Valley-Democratic Party (Obama)
4. **OKR evangelist**: Ha diffuso il framework manageriale da Intel a tutto il tech
5. **Climate tech**: Pioniere cleantech, $1.1B a Stanford
6. **Elite network**: Ospita cene con Jobs, Zuckerberg, Ellison

Il suo pattern e' unico: non e' un fondatore, ma ha plasmato le aziende che hanno plasmato il mondo.
...
### Biografie
- [Wikipedia - John Doerr](https://en.wikipedia.org/wiki/John_Doerr)
- [Kleiner Perkins - John Doerr](https://www.kleinerperkins.com/people/advisors/john-doerr/)
- [Crunchbase - John Doerr](https://www.crunchbase.com/person/john-doerr)

### Istituzioni
- [Obama White House - Jobs Council](https://obamawhitehouse.archives.gov/administration/advisory-boards/jobs-council/members/doerr)
- [TechNet - John Doerr](https://www.technet.org/executive-council/john-doerr/)

### Climate
- [Climate One - John Doerr](https://www.climateone.org/people/john-doerr)
- [Stanford Doerr School Announcement](https://news.stanford.edu/2022/05/04/stanford-sustainability-school/)

### Libri
- "Measure What Matters" (2018) - OKRs
- "Speed & Scale" (2021) - Climate action
