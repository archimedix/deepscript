# Giappone: Mappa del Potere

> Dai zaibatsu ai keiretsu: come il capitalismo di relazione giapponese si trasforma sotto la pressione del capitale globale

---

## Sintesi

Il Giappone rappresenta un **caso studio unico** di transizione del potere economico:

- **Zaibatsu pre-1945**: Famiglie (Mitsui, Mitsubishi, Sumitomo) controllano economia imperiale
- **Dissoluzione SCAP 1946**: Occupazione USA smantella conglomerati
- **Rinascita keiretsu 1950s**: Ricostruzione come gruppi orizzontali senza famiglia al vertice
- **"Iron Triangle"**: LDP + Burocrazia (MOF/METI) + Big Business (Keidanren)
- **Penetrazione Big Three**: 11% del Nikkei 225, in crescita accelerata dal 2024

---

## La Struttura del Potere Giapponese
...
```
    ...
    - JIP coalition - BOJ            - Più grande al mondo
          ...
          +-------+-------+               |
                  ...
                  v                       v
          +-----------------+     +-----------------+
          |   KEIDANREN     |     | ASSET MANAGERS  |
          | (1,758 membri)  |     | (Big Three)     |
          +-----------------+     +-----------------+
                  |                       |
          +-------+-------+               |
          |               |               |
          v               v               v
    [KEIRETSU]      [SOGO SHOSHA]   [INVESTITORI]
    - MUFG          - Mitsubishi    - BlackRock 6%
    - SMFG          - Mitsui        - Vanguard 7%
    - Mizuho        - Itochu        - Berkshire 10%
```
...
### 1. L'Iron Triangle (1955-oggi)

| Vertice | Attori | Meccanismo |
|---------|--------|------------|
| **Politica** | LDP (fazioni) | Donazioni, voti rurali |
| **Burocrazia** | MOF, METI, MOFA | Amakudari (revolving door) |
| **Business** | Keidanren, Keizai Doyukai | Policy input, finanziamenti |

### 2. La Dinastia Kishi-Sato-Abe

Il Giappone e' dominato da **dinastie politiche ereditarie**. La piu' potente:

```
NOBUSUKE KISHI (1896-1987)
PM 1957-60, Class-A war criminal sospetto
         |
    +----+----+
    |         |
    v         v
EISAKU SATO   YOKO KISHI
PM 1964-72    sposata con
Nobel 1974    SHINTARO ABE
              Min. Esteri 1982-86
                   |
         +--------+--------+
         |                 |
   ...
   PM 2006-07         Min. Difesa 2020
   PM 2012-20         (adottato da Kishi)
   † 2022 (assassinato)
```

**3 Primi Ministri** dalla stessa famiglia = **20+ anni** al governo.
...
PENSIONAMENTO ANTICIPATO
         ...
         | "Discesa dal cielo"
         v
BOARD AZIENDALE / NONPROFIT
         |
         v
INFLUENZA PERSISTENTE SU POLICY
```

**Dati**:
- 1,872 collocamenti amakudari (2006-2008) nonostante divieto 2007
- MOF e METI: maggiori "esportatori" di burocrati
- Correlazione: aziende con ex-burocrati ricevono più prestiti governativi

---

## Gli Ex-Zaibatsu: Da Famiglie a Keiretsu

### I "Big Four" Originali

| Zaibatsu | Famiglia | Fondazione | Trasformazione |
|----------|----------|------------|----------------|
| **Mitsui** | Mitsui | 1673 | → SMFG, Mitsui & Co |
| **Mitsubishi** | Iwasaki | 1870 | → MUFG, Mitsubishi Corp |
| **Sumitomo** | Sumitomo | 1590 | → SMFG, Sumitomo Corp |
| **Yasuda** | Yasuda | 1880 | → Mizuho |

### Da Famiglia a Cross-Shareholding

**Pre-1945 (Zaibatsu)**:
```
FAMIGLIA (controllo 100%)
         |
         v
    HONSHA (holding)
         |
...
```
    ...
    |    |    |    |
    v    v    v    v
Trading Insurance Real Estate Mfg
         |
         v
    COORDINAMENTO UMANO
    (ex-dipendenti, meeting)
```

### I "Big Six" Keiretsu Orizzontali

| Keiretsu | Main Bank | Trading Co | Market Cap Totale |
|----------|-----------|------------|-------------------|
| Mitsubishi | MUFG | Mitsubishi Corp | ~$400B |
| Mitsui | SMFG | Mitsui & Co | ~$250B |
| Sumitomo | SMFG | Sumitomo Corp | ~$200B |
| Fuyo | Mizuho | Marubeni | ~$150B |
| Sanwa | MUFG | - | Assorbito |
| DKB | Mizuho | - | Assorbito |

---

## Le Sogo Shosha (Trading Houses)

### I Cinque Giganti + Buffett
...
## Le Megabank e le Partnership Globali

### I Tre Colossi e le Loro Alleanze

| Banca | Assets | Partner USA | Quota | CEO | Scheda |
|-------|--------|-------------|-------|-----|--------|
| [MUFG](../docs/bank/mufg.md) | ¥400T+ | **Morgan Stanley** | **22.41%** | Hironori Kamezawa | [Link](../docs/bank/mufg.md) |
| [SMFG](../docs/bank/smfg.md) | ¥281T | **Jefferies** | **20%** | Toru Nakashima | [Link](../docs/bank/smfg.md) |
| [Mizuho](../docs/bank/mizuho.md) | ¥260T | **Rakuten** (fintech) | **15%** | Masahiro Kihara | [Link](../docs/bank/mizuho.md) |

### Strategie Divergenti

```
MEGABANKS GIAPPONESI: TRE STRATEGIE

MUFG ──────────► MORGAN STANLEY (22.41%)
                 "Wall Street integration"
                 - $9B investimento 2008 (crisi)
                 - Board: Kamezawa Director
                 - JV Securities in Giappone

SMFG ──────────► JEFFERIES (20%)
                 "Investment banking globale"
                 - Alliance 2021, stake increase 2025
                 - Board: Nakashima Director
                 - JV Equity Japan 2027
                 - Multi-franchise Asia
...
### I CEO delle Megabanks: Connessioni Globali

| CEO | Banca | Board esteri | Forum | Note |
|-----|-------|--------------|-------|------|
| [Hironori Kamezawa](../docs/persons/hironori-kamezawa.md) | MUFG | **Morgan Stanley**, **Hakluyt** | - | Advisory Board Hakluyt (intelligence) |
| [Toru Nakashima](../docs/persons/toru-nakashima.md) | SMFG | **Jefferies** | - | Board dal 2024 |
| [Masahiro Kihara](../docs/persons/masahiro-kihara.md) | Mizuho | - | **WEF Davos 2025** | "Best Bank CEO Japan" 2025 |

### Partecipazioni Big Three nelle Megabank

| Banca | BlackRock | Vanguard | State Street | Totale |
|-------|-----------|----------|--------------|--------|
| MUFG | 4.5% | 5.0% | 2.5% | **12.0%** |
| SMFG | 4.0% | 4.5% | 2.5% | **11.0%** |
| Mizuho | 4.0% | 4.5% | 2.5% | **11.0%** |

### Il Triangolo MUFG-Morgan Stanley-GPIF
...
**Kazuto Uchida** e' il **ponte umano** tra finanza privata e fondi pubblici:
- Chief Economist MUFG → President GPIF (2025)
- Primo presidente GPIF proveniente da banca privata
- GPIF delega gestione a BlackRock, che ha mandati anche da MUFG

### SMFG: Strategia Multi-Franchise in Asia

| Paese | Entita' | Quota | Anno | Note |
|-------|---------|-------|------|------|
| Indonesia | [Bank BTPN](../docs/bank/bank-btpn.md) | consolidata | 2019 | 10a banca Indonesia |
| Vietnam | FE Credit | 49% | 2021 | Consumer finance leader |
| Vietnam | [VPBank](../docs/bank/vpbank.md) | 15% | 2023 | Impairment ¥46B |
| Filippine | RCBC | partner | - | Capital infusion |

SMFG e' la **piu' aggressiva** nell'espansione Asia emergente, ma con risultati misti (impairment Vietnam 2023).

### Mizuho: Il Peso del Legacy IT

| Anno | Crisi IT | Impatto |
|------|----------|---------|
| **2002** | Lancio disastroso | 2.5M transazioni non processate |
| **2011** | Ulteriori guasti | - |
| **2021** | 8 fallimenti in 8 mesi | Dimissioni CEO e President |

Mizuho ha ereditato **tre sistemi IT legacy** dai keiretsu predecessori (DKB, Fuji, IBJ) mai completamente integrati. Kihara e' stato nominato CEO nel 2022 per gestire la crisi.

---

## La Banca Centrale (BOJ)

### Storia e Fondazione

| Dato | Dettaglio |
|------|-----------|
| **Fondazione** | 10 ottobre 1882 |
| **Fondatore** | Matsukata Masayoshi (Min. Finanze) |
| **Modello** | National Bank of Belgium |
| **BIS** | Membro fondatore 1930 |
| **Proprieta'** | 55% Governo, 45% privati (unico al mondo) |

[Scheda completa](../docs/central-bank/bank-of-japan.md)

### Governatori Recenti

| Governatore | Periodo | Policy | Note |
|-------------|---------|--------|------|
| [Toshihiko Fukui](../docs/persons/toshihiko-fukui.md) | 2003-2008 | Post-bolla | Direttore BIS |
| Masaaki Shirakawa | 2008-2013 | Post-crisi | Primo accademico |
| [Haruhiko Kuroda](../docs/persons/haruhiko-kuroda.md) | 2013-2023 | QQE, YCC, NIRP | Ex-ADB President, nominato da Abe |
| [Kazuo Ueda](../docs/persons/kazuo-ueda.md) | 2023- | Fine tassi negativi | Secondo accademico |

### Connessione Abe-Kuroda (Abenomics)

```
SHINZO ABE (PM 2012-2020)
         |
         | Nomina febbraio 2013
         v
HARUHIKO KURODA (Gov BOJ 2013-2023)
         |
         | Implementa
         v
ABENOMICS: QQE + YCC + NIRP
         |
         | Risultato
         v
Yen -50%, Nikkei +200%, Inflazione <2%
```

**La "Terza Freccia"**: Abe e Kuroda hanno coordinato politica fiscale e monetaria come mai prima in Giappone. Kuroda, ex-Presidente ADB (2005-2013), era scelta di Abe per rompere la deflazione.

### Politiche Pionieristiche

| Politica | Anno | Prima al mondo |
|----------|------|----------------|
| ZIRP (tassi zero) | 1999 | Si' |
| QE (quantitative easing) | 2001 | Si' |
| QQE (qualitative & quantitative) | 2013 | Variante |
| NIRP (tassi negativi) | 2016 | Tra le prime |
| YCC (yield curve control) | 2016 | Si' |
| **Fine NIRP** | **Marzo 2024** | Primo rialzo in 17 anni |

### BOJ come Azionista

La BOJ detiene ~7% del mercato azionario giapponese via ETF:
- Acquisti iniziati 2010
- Accelerati sotto Kuroda (2013)
- $400B+ in ETF al 2024
- Dibattito su exit strategy

**BOJ + GPIF**: Insieme detengono ~13% del mercato azionario giapponese

---

## GPIF: Il Gigante dei Fondi Pensione

### Dati Chiave

| Metrica | Valore |
|---------|--------|
| AUM | **$1.87 trilioni** (277T yen) |
| Ranking | **#1 mondiale** |
| Fondazione | 2006 |
| Dipendenti | Solo 187 |
| Allocazione | 25% ciascuno: dom bonds, for bonds, dom eq, for eq |
| President | Kazuto Uchida (2025-, ex-MUFG) |

[Scheda completa](../docs/swf/gpif.md)

### La Rivoluzione Mizuno (2015-2020)

[Hiro Mizuno](../docs/persons/hiro-mizuno.md), CIO 2015-2020, ha trasformato GPIF in **leader globale ESG**:

| Iniziativa | Anno | Impatto |
|------------|------|---------|
| Firma PRI | 2015 | Primo grande fondo giapponese |
| Stewardship Code | 2017 | Peso aumentato da 5% a **30%** |
| Taglio BlackRock JP | 2018-19 | Per stewardship insufficiente |
| Climate Action 100+ | - | Membro fondatore |

**Dopo GPIF**: Mizuno e' diventato UN Special Envoy per Finanza Sostenibile e board member Tesla (2020-2024).

### Relazione con Big Three

GPIF commissiona **80% dell'equity a strategie passive**:

| Manager | Ruolo | Note |
|---------|-------|------|
| **BlackRock** | Largest manager | Mandato ridotto 2019 per stewardship |
| State Street | Passive equity | Aumentato 2019 |
| Legal & General | Passive equity | Aumentato 2019 |
| Mitsubishi UFJ Trust | Domestic | - |
...
BLACKROCK + altri
    |
    | vota nelle assemblee
    v
AZIENDE GIAPPONESI
    |
    | lobbying via Keidanren
    v
GOVERNO GIAPPONE
```

GPIF e' il **ponte** tra stato giapponese e capitale globale: fondi pubblici giapponesi gestiti da asset manager americani che votano nelle aziende giapponesi.

---

## Connessioni Globali

### L'Eredita' Strategica di Shinzo Abe

Shinzo Abe ha ridefinito il ruolo geopolitico del Giappone con due iniziative chiave:
...
INDIA ←→ AUSTRALIA
```
Dialogo quadrilaterale di sicurezza per contenere la Cina. Ideato da Abe nel 2007, rilanciato nel 2017.

**2. Free and Open Indo-Pacific (FOIP, 2016)**
- Strategia per "arco delle democrazie" dall'Africa all'Oceania
- Adottata da USA (Trump, poi Biden), Australia, India
- Base per escludere Cina da catene di fornitura critiche

**3. Abenomics + Kuroda (2013-2020)**
- Coordinamento senza precedenti PM-BOJ
- "Terza freccia": Corporate Governance Code 2015
- Apertura a investitori esteri (Big Three)

[Scheda Shinzo Abe](../docs/persons/shinzo-abe.md) | [Famiglia Kishi-Sato-Abe](../docs/family/kishi-sato-abe.md)
...
- Ex-ambasciatori USA
- Chairman JIIA
- Ex-Goldman Sachs Japan
- Ex-IMF officials

### WEF - Young Global Leaders Giapponesi

| Nome | Affiliazione | Anno YGL |
|------|--------------|----------|
| Haruka Mera | - | - |
| Miku Hirano | - | - |
...
Keidanren partecipa al **B7** (Business 7) prima di ogni G7:
- Vice-Chair Toshiaki Higashihara
...
|-----------|--------|
| Fondazione | 1959 |
| Fondatore | PM Shigeru Yoshida |
| Modello | Chatham House |
...
| Azienda | Market Cap ($B) | Big Three % | Settore |
|---------|-----------------|-------------|---------|
...
| Fast Retailing | 102.0 | 8.0% | Retail |
| SMFG | 97.7 | 11.0% | Bank |
| NTT | 88.8 | 8.0% | Telecom |
| Tokyo Electron | 84.9 | 12.0% | Semiconductor |

### Partecipazioni Big Three Dettagliate
...
### Da Creare - Think Tank / Diplomacy
...
| ID | Tipo | Scheda |
|----|------|--------|
| governo-giappone | Government | [Link](../docs/government/governo-giappone.md) |
| **bank-of-japan** | CentralBank | [Link](../docs/central-bank/bank-of-japan.md) |
...
| masaaki-shirakawa | Gov. BOJ 2008-13 | - |
| **hiro-mizuno** | CIO GPIF 2015-20 | Rivoluzione ESG |
| **kazuto-uchida** | Pres. GPIF 2025- | **Ex-MUFG** - ponte banca privata→fondi pubblici |
| **hironori-kamezawa** | CEO MUFG 2020- | **Board Morgan Stanley + Hakluyt Advisory** |
| **toru-nakashima** | CEO SMFG 2023- | **Board Jefferies** |
| **masahiro-kihara** | CEO Mizuho 2022- | **WEF Davos 2025**, post-crisi IT |
...
| ID | Tipo | Scheda | Note |
|----|------|--------|------|
| **mufg** | Bank | [Link](../docs/bank/mufg.md) | Morgan Stanley 22%, Hakluyt |
| **smfg** | Bank | [Link](../docs/bank/smfg.md) | Jefferies 20%, multi-franchise Asia |
| **mizuho** | Bank | [Link](../docs/bank/mizuho.md) | Rakuten 15%, crisi IT |
| **hakluyt** | Company | Stub | Strategic intelligence, MI6 links |
| **jefferies** | Bank | Stub | SMFG partner |
...
## Pattern del Potere Giapponese

### 1. Dissoluzione Incompleta (1946)

I zaibatsu furono "sciolti" ma:
- Manager rimasero in carica
- Relazioni informali preservate
- Ricostruzione come keiretsu (1950s)
- Cross-shareholding sostituì proprietà familiare

### 2. Il "Capitalismo di Relazione"

```
BANCHE → Prestiti preferenziali → AZIENDE GRUPPO
   ↑                                    |
   |    Cross-shareholding 5-10%        |
   +------------------------------------+
```
...
- Supplier keiretsu (verticali)
- Coordinamento informale

### 3. La Dissoluzione dei Keiretsu (2000-2024)

| Fase | Periodo | Driver |
|------|---------|--------|
| Crisi banche | 1990s | Bad loans, consolidamento |
| Riforme Koizumi | 2001-06 | Privatizzazioni |
| Abenomics | 2012-20 | Corporate governance code |
| Scandali LDP | 2024 | Pressione su cross-shareholdings |

### 4. L'Ingresso dei Big Three

| Anno | Evento |
|------|--------|
| 2014 | Stewardship Code |
| 2015 | Corporate Governance Code |
| 2018 | GPIF aumenta equity allocation |
| 2020 | Buffett investe in sogo shosha |
| 2022 | TSE riforma (Prime Market) |
| 2024 | Scandalo LDP accelera dissoluzione cross-shareholdings |
| 2025 | Toyota buyback ¥1.2T |

---

## Tesi: Il Modello Giapponese in Transizione

### Da Capitalismo di Relazione a Capitalismo Finanziario

**Prima** (1955-2000):
- Famiglie → Keiretsu → Cross-shareholding
- Banche al centro
- Azionisti esteri marginali
- Long-term orientation

**Dopo** (2000-oggi):
- Cross-shareholding in dissoluzione
- GPIF + Big Three = nuovi arbitri
- Azionisti esteri ~30% del mercato
- Pressione su dividendi e buyback

### Il Paradosso Giapponese

> Le riforme post-bolla hanno aperto il Giappone al capitale globale più di qualsiasi altro paese asiatico sviluppato

- **11%** penetrazione Big Three (vs 7.5% Cina, 6.2% India)
- **Toyota 18%** in mani Big Three - più di qualsiasi chaebol coreano
- **Berkshire 10%** nelle sogo shosha - benedizione di Buffett
- **GPIF** commissiona gestione a BlackRock
...
```cypher
-- Famiglia Kishi-Sato-Abe e affiliazioni
MATCH (p:Person)-[:MEMBER_OF]->(f:Family {id: 'kishi-sato-abe'})
OPTIONAL MATCH (p)-[r:AFFILIATED_WITH]->(o:Organization)
RETURN p.id, p.born, p.died, o.id, r.role, r.note

-- Governatori BOJ e connessioni
MATCH (p:Person)-[r:AFFILIATED_WITH]->(boj:Organization {id: 'bank-of-japan'})
OPTIONAL MATCH (p)-[r2:AFFILIATED_WITH]->(other:Organization)
WHERE other.id <> 'bank-of-japan'
RETURN p.id, r.from, r.to, r.note, collect(other.id)

-- Leadership GPIF
MATCH (p:Person)-[r:AFFILIATED_WITH]->(gpif:Organization {id: 'gpif'})
RETURN p.id, r.role, r.from, r.to, r.note

-- Aziende giapponesi con stake Big Three
MATCH (am:AssetManager)-[s:STAKE_IN]->(c)
WHERE c.headquarters CONTAINS 'Japan'
RETURN am.id, c.id, s.share
ORDER BY c.id

-- Persone giapponesi connesse a forum globali
MATCH (p:Person {nationality: 'JPN'})-[:AFFILIATED_WITH]->(f:Forum)
RETURN p.id, f.id

-- Network sogo shosha
MATCH (c:Company)
WHERE c.id IN ['mitsubishi-corp', 'mitsui-co', 'itochu', 'sumitomo-corp', 'marubeni']
OPTIONAL MATCH (am:AssetManager)-[s:STAKE_IN]->(c)
RETURN c.id, collect({am: am.id, share: s.share})

-- NUOVO: Megabanks e loro partnership globali
MATCH (mb:Bank)
WHERE mb.id IN ['mufg', 'smfg', 'mizuho']
OPTIONAL MATCH (mb)-[s:STAKE_IN]->(partner)
RETURN mb.id, mb.name, collect({partner: partner.id, share: s.share})

-- NUOVO: CEO Megabanks e tutte le affiliazioni
MATCH (p:Person)-[r:AFFILIATED_WITH]->(mb:Bank)
WHERE mb.id IN ['mufg', 'smfg', 'mizuho'] AND r.role = 'executive'
OPTIONAL MATCH (p)-[r2:AFFILIATED_WITH]->(other:Organization)
WHERE NOT other.id IN ['mufg', 'smfg', 'mizuho']
RETURN p.id, mb.id as bank, collect({org: other.id, role: r2.role, note: r2.note})

-- NUOVO: Triangolo MUFG-Morgan Stanley-GPIF
MATCH path = (mufg:Bank {id: 'mufg'})-[:STAKE_IN]->(ms:Bank {id: 'morgan-stanley'})
OPTIONAL MATCH (p:Person)-[:AFFILIATED_WITH]->(mufg)
OPTIONAL MATCH (p)-[:AFFILIATED_WITH]->(gpif:SWF {id: 'gpif'})
RETURN mufg.id, ms.id, p.id, gpif.id

-- NUOVO: SMFG Multi-franchise Asia
MATCH (smfg:Bank {id: 'smfg'})-[s:STAKE_IN]->(partner:Bank)
RETURN smfg.id, partner.id, partner.headquarters, s.share, s.note
```
...
### Megabanks
- [MUFG - Official](https://www.mufg.jp/english/)
- [SMFG - Official](https://www.smfg.co.jp/english/)
- [Mizuho - Official](https://www.mizuhogroup.com/)
- [Morgan Stanley - MUFG Investment](https://www.morganstanley.com/press-releases/mitsubishi-ufj-financial-group-to-invest-9-billion-in-morgan-stanley_6962)
- [Hakluyt - Kamezawa Advisory Board](https://hakluytandco.com/news/hironori-kamezawa-joins-hakluyts-international-advisory-board/)
- [Jefferies - Nakashima Board](https://www.businesswire.com/news/home/20240812348500/en/)
- [Bloomberg - Kihara at Davos 2025](https://www.bloomberg.com/news/videos/2025-01-22/mizuho-financial-president-group-ceo-at-davos-video)

### Istituzioni
- [Bank of Japan - Official](https://www.boj.or.jp/en/)
- [GPIF - Official](https://www.gpif.go.jp/en/)
- [Keidanren](http://www.keidanren.or.jp/en/profile/)
- [JIIA](https://www.jiia.or.jp/eng/)

### Forum
- [Trilateral Commission - Asia Pacific](https://www.trilateral.org/regions/asia-pacific-group/)
- [WEF - Abe Davos 2019](https://www.weforum.org/stories/2019/01/abe-speech-transcript/)

### Wikipedia
- [Wikipedia - Shinzo Abe](https://en.wikipedia.org/wiki/Shinzo_Abe)
- [Wikipedia - Sato-Kishi-Abe family](https://en.wikipedia.org/wiki/Satō–Kishi–Abe_family)
- [Wikipedia - Bank of Japan](https://en.wikipedia.org/wiki/Bank_of_Japan)
- [Wikipedia - GPIF](https://en.wikipedia.org/wiki/Government_Pension_Investment_Fund)
...
- [Top1000Funds - GPIF](https://www.top1000funds.com/asset_owner/government-pension-investment-fund-gpif/)
- [Companiesmarketcap - Japan](https://companiesmarketcap.com/japan/largest-companies-in-japan-by-market-cap/)
