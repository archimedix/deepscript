...
> Lo Stato della Start-up Nation: sicurezza, tecnologia e rete globale

## Executive Summary

Israele rappresenta un caso unico di **potenza cyber-militare-tecnologica**: una nazione di 9 milioni di abitanti che produce il 25% delle aziende di cybersecurity mondiali, mantiene uno dei servizi di intelligence piu' efficaci al mondo, e ha costruito una rete di influenza che collega Washington, Silicon Valley e ora anche il Golfo.

**Tesi centrale**: Il potere israeliano si articola su tre pilastri interconnessi:
1. **Complesso militare-intelligence** (IDF, Mossad, Unit 8200) che genera talento tech
2. **Oligarchia industriale** (Ofer, Federmann, Wertheimer, Tshuva) che controlla difesa ed energia
3. **Pipeline cyber-VC** (Unit 8200 → startup → exit miliardarie → reinvestimento)

La recente normalizzazione con UAE (Abraham Accords) ha aperto un nuovo asse di potere: **Gerusalemme-Abu Dhabi**, con investimenti reciproci in tech, energia e AI.

### Chi Detiene il Potere Reale (2025)
...
| **Shipping/RE** | [Famiglia Ofer](../docs/family/ofer.md) | $50B+, Eyal (#1 Forbes Israel) |
...
```
     ...
     |                     |                     |
     v                     v                     v
 INTELLIGENCE         GOVERNO              INDUSTRIA
     |                     |                     |
+----+----+          +-----+-----+         +-----+-----+
|         |          |           |         |           |
v         v          v           v         v           v
Mossad  Unit      Netanyahu   Knesset   Difesa    Finanza
        8200                              |           |
  |       |                         +-----+-----+ +---+---+
  |       |                         |     |     | |       |
  v       v                         v     v     v v       v
+---+ +-------+                   Elbit IAI Rafael Bank  Bank
|CIA| |Silicon|                   (Feder-      |    Leumi Hapoalim
|   | |Valley |                    mann)       |      |      |
+---+ |Startup|                      |         |      +------+
      +---+---+                      +---------+         |
          |                               |              v
          v                               v         Arison
    +----------+                   EXPORT DIFESA    Family
    |Check-    |                   $14.8B (2024)
    |Point     |                         |
    |Wiz $32B  |                         v
    |CyberArk  |               +---------+---------+
    ...
    +----+-----+               v         v         v
         |                   USA       UAE      Europa
         v                (AIPAC)   (Abraham   (Arrow-3
    SILICON VALLEY              Accords)   Germania)
    +------------+                   |
    |Berkshire   |                   v
    |Google      |            +------+------+
    |SoftBank    |            |Mubadala     |
...
## Il Centro del Potere Politico: Benjamin Netanyahu

> Vedi scheda completa: [Benjamin Netanyahu](../docs/persons/benjamin-netanyahu.md)

[Benjamin Netanyahu](../docs/persons/benjamin-netanyahu.md) e' il primo ministro piu' longevo della storia israeliana (18+ anni), e rappresenta il punto di convergenza tra potere politico, militare e industriale.

### Profilo

| Aspetto | Dettaglio |
|---------|-----------|
| **Nascita** | 21 ottobre 1949, Tel Aviv |
| **Background** | Sayeret Matkal (elite IDF), MIT (MSc), Ambasciatore ONU |
| **Mandati PM** | 1996-99, 2009-21, 2022-oggi |
| **Record** | Primo PM incriminato in carica (2019) |
...
```
      ...
      |                      |                      |
      v                      v                      v
   SICUREZZA             ECONOMIA               GLOBAL
      |                      |                      |
+-----+-----+          +-----+-----+          +-----+-----+
|           |          |           |          |           |
v           v          v           v          v           v
IDF      Mossad     Piano      Abraham     WEF       AIPAC
Sayeret  (Yossi    $110B      Accords   Speaker   (lobby)
Matkal    Cohen)   difesa     UAE/Gulf
```
...
| Data | Evento | Impatto |
|------|--------|---------|
| **Nov 2024** | ICC arrest warrant | Isolamento internazionale |
| **Nov 2024** | Licenziamento Min. Difesa Gallant | Proteste interne |
| **Ott 2024** | Invasione Libano | Escalation regionale |
| **Dic 2024** | Invasione Siria (post-Assad) | Espansione territoriale |
| **Mar 2025** | Fine cessate fuoco Gaza | Rinvio processo corruzione |
| **Mar 2025** | Licenziamento capo Shin Bet | Conflitto intelligence |
| **Giu 2025** | Attacco Iran (nucleare) | Guerra regionale |
| **Nov 2025** | Richiesta grazia | Exit strategy legale? |

### Il Piano dei $110 Miliardi

Netanyahu ha annunciato un piano decennale da $110 miliardi per l'autosufficienza militare israeliana, motivato da:
- Embargo armi USA/UK/Germania durante guerra Gaza
- Dipendenza critica da forniture esterne
- Dottrina "Super-Sparta" (controversa)

---

## I Pilastri del Potere

### 1. Le Grandi Famiglie Industriali

| Famiglia | Settore | Patrimonio | Aziende Chiave | Connessioni |
|----------|---------|------------|----------------|-------------|
| [Ofer](../docs/family/ofer.md) | Shipping, RE, Energia | $50B+ | Quantum Pacific, Israel Corp | Atletico Madrid (33%) |
| [Federmann](../docs/family/federmann.md) | Difesa, Hotel | $5B | [Elbit Systems](../docs/defense/elbit-systems.md), Dan Hotels | Chairman Elbit |
...
> Vedi schede: [Stef Wertheimer](../docs/persons/stef-wertheimer.md), [Eitan Wertheimer](../docs/persons/eitan-wertheimer.md)

La famiglia Wertheimer rappresenta il modello ideale di **dinastia industriale israeliana**: rifugiati tedeschi che hanno costruito un impero manifatturiero venduto poi a Warren Buffett.

**Timeline della Successione:**

| Anno | Evento | Protagonista |
|------|--------|--------------|
| **1937** | Fuga dalla Germania nazista | Stef (11 anni) |
| **1952** | Fondazione ISCAR (nel giardino di casa) | [Stef Wertheimer](../docs/persons/stef-wertheimer.md) |
| **1988** | Eitan diventa Chairman | [Eitan Wertheimer](../docs/persons/eitan-wertheimer.md) |
| **1995** | Eitan CEO (dopo incidente padre) | Eitan |
| **2006** | Vendita 80% a Berkshire Hathaway | $4 miliardi |
| **2013** | Vendita restante 20% | $2.05 miliardi |
| **2022** | Morte Eitan (cancro, 70 anni) | Fine Gen-2 |
| **2025** | Morte Stef (98 anni) | Fine fondatore |

**Filosofia Wertheimer**: Coesistenza arabo-ebraica attraverso sviluppo industriale

> "Give a man a job and he won't want to blow himself up." — Stef Wertheimer
...
| Azienda | Ricavi 2024 | Backlog 2024 | Proprieta' | Prodotti Chiave |
|---------|-------------|--------------|------------|-----------------|
| [Elbit Systems](../docs/defense/elbit-systems.md) | **$6.83B** | $22.6B | Federmann (42%) | Droni, elettronica, visione notturna |
| [Israel Aerospace Industries](../docs/defense/israel-aerospace-industries.md) | **$6.1B** | **$25B** | Stato 100% | Arrow, Heron, satelliti |
| [Rafael](../docs/defense/rafael.md) | **$4.8B** | **$17.5B** | Stato 100% | Iron Dome, Iron Beam, Spike, Trophy |

**Totale triangolo**: ~$17.7B ricavi, ~$65B backlog - record storici post-Gaza

**Export difesa 2024**: $14.8 miliardi (record storico)
**Piano Netanyahu 2025**: $110 miliardi in 10 anni per autosufficienza militare
...
(laser, 0-10km)                                    **$3 per shot**
```

#### Iron Beam: Game Changer (2024)
...
**Implicazione**: Rivoluziona l'economia della difesa aerea - neutralizza asimmetria drone swarm.

#### Export come Diplomazia

| Cliente | Sistema | Valore | Anno |
|---------|---------|--------|------|
| Germania | Arrow 3 (IAI) | **$3.1B** | 2023 |
| India | Barak-8 (IAI) | $2.4B | 2020 |
| Finlandia | David's Sling (Rafael) | - | 2023 |
| Grecia | Multi-layer (trattativa) | $3.5B | - |

#### Leadership Triangolo
...
| Fondatore | Azienda | Exit/Valutazione | Anno |
|-----------|---------|------------------|------|
| [Shlomo Kramer](../docs/persons/shlomo-kramer.md) | Check Point, Imperva, Cato | $2.2B patrimonio | 1993 |
| [Nir Zuk](../docs/persons/nir-zuk.md) | Palo Alto Networks | $110B market cap | 2005 |
| [Udi Mokady](../docs/persons/udi-mokady.md) | CyberArk | $15B market cap | 1999 |
...
### USA: AIPAC e Asse Politico

| Organizzazione | Ruolo | Donatori Chiave | Impatto 2024 |
|----------------|-------|-----------------|--------------|
| [AIPAC](../docs/think-tank/aipac.md) | Lobby pro-Israel | [Haim Saban](../docs/persons/haim-saban.md), Paul Singer, Bernard Marcus | $100M spesi, 96% candidati eletti |
...
| Investimento | Valore | Parti | Anno |
|--------------|--------|-------|------|
| Mubadala → Tamar gas | $1B (22%) | Mubadala, Delek | 2021 |
| G42 + Rafael + Silver Lake | JV R&D | G42, Rafael | 2021 |
| Mubadala → VC israeliani | $20M+ | Pitango, Viola, Aleph | 2021+ |
| UAE → settori strategici | $10B allocati | Vari | 2020+ |

**Connettore chiave**: [Sheikh Tahnoun bin Zayed](../docs/persons/sheikh-tahnoun-bin-zayed.md) (G42, ADIA, ADQ) ↔ Rafael

#### EDGE Group: Il Campione Difesa UAE

| Metrica | 2019 | 2024 |
|---------|------|------|
| Ricavi | ~$50M export | **$5B** |
| Export | $50M | **$3.7B** (2025 est.) |
| Rank SIPRI | - | **#22** mondiale |
| Dipendenti | - | 14.000 |

**Leadership EDGE:**
- [Faisal Al Bannai](../docs/persons/faisal-al-bannai.md) - Chairman, Time 100 Most Influential in AI 2024
- [Hamad Al Marar](../docs/persons/hamad-al-marar.md) - CEO dal 2024

**Partnership strategiche:**
| Partner | Progetto | Implicazione |
|---------|----------|--------------|
| **Baykar** (Turchia) | Armi EDGE su Bayraktar | Asse UAE-Turchia |
| **Fincantieri** (Italia) | JV MAESTRAL | Accesso tech navale |
| **Rafael** (Israele) | R&D via G42 | Abraham Accords defense |

> Vedi scheda: [EDGE Group](../docs/defense/edge-group.md)

### Europa: Vendite Difesa

| Cliente | Sistema | Valore |
|---------|---------|--------|
| Germania | Arrow-3 (IAI) | $3.1B |
| UK | Elbit Systems | Multi-miliardo |
| India | Rafael, IAI | $2B+ |

---

## Revolving Door: Intelligence/Politica → Business

Pattern distintivo israeliano: ex-capi intelligence e ministri entrano in posizioni di potere economico
...
| Persona | Ruolo Governo | Ruolo Industria |
|---------|---------------|-----------------|
| [Yuval Steinitz](../docs/persons/yuval-steinitz.md) | Finance/Intelligence/Energy Minister (2009-21) | **Chairman Rafael** (2023-) |
| [Amir Peretz](../docs/persons/amir-peretz.md) | Defense Minister (2006-07) | **Chairman IAI** (2021-24) |

#### Il Caso Steinitz: Pattern Unico
...
ACADEMIA (1980s-90s)
     ...
     └──► Best-seller "Invitation to Philosophy"
            │
            ▼
PEACE NOW (1980s) ──► Ferito in attentato 1983
            │
            ▼
LIKUD (1995-) ──► Shift a destra, critico Oslo
            │
            ▼
KNESSET/GOVERNO (1999-2021)
     │
     ├──► Finance Minister (2009-13)
     ├──► Intelligence Minister (2013-15) - Iran dossier
     ├──► Energy Minister (2015-21)
...
**Pattern**: L'**architetto della dottrina anti-Iran** ora supervisiona i sistemi che la implementano. A differenza del pattern USA (generali → board), in Israele il revolving door opera a livello **politico** (ministri → chairman contractor)

---

## Top Connettori Israeliani (Database)
...
| Persona | Anno YGL | Ruolo |
|---------|----------|-------|
| [Efrat Peled](../docs/persons/efrat-peled.md) | 2009 | Business |
| [Yair Goldfinger](../docs/persons/yair-goldfinger.md) | 2009 | ICQ co-founder |
| [Gila Gamliel](../docs/persons/gila-gamliel.md) | - | Ministro |
| [Idan Roll](../docs/persons/idan-roll.md) | 2023 | Diplomatico |
| [Stav Shaffir](../docs/persons/stav-shaffir.md) | - | Attivista |

---

## Sistema Bancario

| Banca | Asset | Proprieta' | Note |
|-------|-------|-----------|------|
| [Bank Leumi](../docs/bank/bank-leumi.md) | #1 Israel | Shlomo Eliyahu (10%), Stato (14.8%) | Nazionalizzata 1983, privatizzata |
| [Bank Hapoalim](../docs/bank/bank-hapoalim.md) | #2 Israel | Ex-Arison (venduta 2019) | Fondata Histadrut 1921 |
| [Bank of Israel](../docs/central-bank/bank-of-israel.md) | Banca Centrale | Stato | Fondata 1954 |

---

## Acquisizioni Chiave

| Target | Acquirente | Valore | Anno | Significato |
|--------|------------|--------|------|-------------|
| ISCAR | Berkshire Hathaway | $6B totale | 2006/2013 | Buffett entra in Israel |
| Wiz | Google | $32B | 2024 | Largest Israeli exit |
| Mobileye | Intel | $15.3B | 2017 | Autonomous driving |
...
| Export difesa 2024 | $14.8B (record) |
| Budget difesa 2026 | $35B (16% PIL) |
| Piano difesa Netanyahu | $110B in 10 anni |
...
## Eventi Critici 2024-2025

| Data | Evento | Impatto sul Potere |
|------|--------|-------------------|
| **7 Ott 2023** | Attacco Hamas | Crisi sicurezza, Netanyahu sotto pressione |
| **Ott 2024** | Invasione Libano | Escalation regionale contro Hezbollah |
| **Nov 2024** | ICC arrest warrant Netanyahu | Isolamento internazionale |
| **Nov 2024** | Licenziamento Min. Difesa Gallant | Proteste, frattura interna |
...
### Billionaires e Famiglie
- [Times of Israel - Israeli Billionaires 2025](https://www.timesofisrael.com/41-israelis-are-in-the-billionaires-club-with-wiz-founders-doubling-their-fortunes/)
- [Forbes Israel Billionaires 2025](https://israelbusinessguide.com/news/israeli_billionaires_forbes_2025/)
- [Wikipedia - Yitzhak Tshuva](https://en.wikipedia.org/wiki/Yitzhak_Tshuva)

### Wertheimer
- [Stef Wertheimer Obituary - Bloomberg](https://www.bloomberg.com/news/articles/2025-03-26/stef-wertheimer-who-sold-toolmaker-iscar-to-buffett-dies-at-98)
- [Times of Israel - Stef Wertheimer Obituary](https://www.timesofisrael.com/billionaire-industrialist-and-philanthropist-stef-wertheimer-dies-at-98/)
- [Times of Israel - Eitan Wertheimer Obituary](https://www.timesofisrael.com/billionaire-businessman-eitan-wertheimer-dies-at-70/)
- [ISCAR Founders](https://www.iscar.com/newarticles.aspx/lang/en/newarticleid/1818)

### Netanyahu e Politica
- [Wikipedia - Benjamin Netanyahu](https://en.wikipedia.org/wiki/Benjamin_Netanyahu)
- [Britannica - Benjamin Netanyahu](https://www.britannica.com/biography/Benjamin-Netanyahu)
- [CNN - Netanyahu Fast Facts](https://www.cnn.com/world/middleeast/benjamin-netanyahu-fast-facts)
...
- [Rafael - Sito ufficiale](https://www.rafael.co.il)
- [Wikipedia - Israel Aerospace Industries](https://en.wikipedia.org/wiki/Israel_Aerospace_Industries)
- [Wikipedia - Rafael Advanced Defense Systems](https://en.wikipedia.org/wiki/Rafael_Advanced_Defense_Systems)
- [Wikipedia - Iron Beam](https://en.wikipedia.org/wiki/Iron_Beam)
- [Defence Industry EU - IAI Record 2024](https://defence-industry.eu/israel-aerospace-industries-iai-reports-record-profits-and-orders-in-2024/)
- [National Interest - Rafael Record 2024](https://nationalinterest.org/blog/buzz/israels-rafael-defense-firm-saw-record-sales-in-2024)
