...
```
                    FEDERAZIONE UAE ($2.5T asset sovrani)
                              |
         +--------------------+--------------------+
         |                                         |
         v                                         v
   ABU DHABI (90% PIL)                      DUBAI (trade hub)
   Famiglia Al Nahyan                       Famiglia Al Maktoum
         |                                         |
    +----+----+                              +-----+-----+
    |         |                              |           |
    v         v                              v           v
...
### Al Nahyan: Abu Dhabi (Potere Federale)

> Vedi scheda completa: [Famiglia Al Nahyan](../docs/family/al-nahyan.md)

| Aspetto | Dettaglio |
|---------|-----------|
| **Fondatore** | Sheikh Shakhbut bin Sultan (1928) |
| **Modernizzatore** | [Sheikh Zayed bin Sultan](../docs/persons/sheikh-zayed-bin-sultan.md) (1966-2004) |
| **Emirato** | Abu Dhabi (86% territorio UAE, 90% PIL) |
| **Asset controllati** | $1.7+ trilioni (ADIA, Mubadala, ADQ) |
| **Status** | Famiglia piu' ricca del mondo (#2 Forbes 2024) |

### I "Bani Fatima": Il Nucleo del Potere

I sei figli di Sheikh Zayed con Fatima bint Mubarak formano il blocco dominante:

| Nome | Ruolo | Organizzazioni Chiave |
|------|-------|----------------------|
| [Mohammed bin Zayed (MBZ)](../docs/persons/mohammed-bin-zayed.md) | Presidente UAE, Ruler Abu Dhabi | Governo UAE |
| [Tahnoun bin Zayed](../docs/persons/sheikh-tahnoun-bin-zayed.md) | NSA, Deputy Ruler | ADIA, ADQ, G42, MGX, FAB |
| [Mansour bin Zayed](../docs/persons/mansour-bin-zayed.md) | Vice Presidente, Min. Affari Presidenziali | EIA, ADUG, Man City owner |
| [Abdullah bin Zayed](../docs/persons/abdullah-bin-zayed.md) | Ministro Esteri | Governo UAE |
| Hazza bin Zayed | Vice Chairman Executive Council | - |
| Khalid bin Zayed | - | - |
...
| Persona | Ruolo | Dal |
|---------|-------|-----|
| [Khaled bin Mohamed Al Nahyan](../docs/persons/khaled-bin-mohamed-al-nahyan.md) | Crown Prince Abu Dhabi | 2023 |
| Theyab bin Mohamed | Chairman Abu Dhabi Crown Prince Court | 2023 |

### Al Maktoum: Dubai (Hub Commerciale)

> Vedi scheda completa: [Famiglia Al Maktoum](../docs/family/al-maktoum.md)

| Aspetto | Dettaglio |
|---------|-----------|
| **Fondatore moderno** | Sheikh Rashid bin Saeed (1958-1990) |
| **Emirato** | Dubai |
| **Modello** | Trade hub, turismo, finanza, aviazione |
| **Asset controllati** | $380B+ (via ICD) |

### Leadership Al Maktoum
...
## Sovereign Wealth Funds: L'Impero Finanziario

Gli UAE possiedono il piu' grande ecosistema di SWF al mondo con ~$2.5 trilioni AuM combinati.

### Overview SWF

| SWF | AuM | Chairman | Focus | Rank Globale |
|-----|-----|----------|-------|--------------|
...
| **Dipendenti** | 1,700+ da 65 nazioni |
| **Strategia** | Long-term, diversificato, low profile |

**Investimenti Noti:**
- Carlyle Group, Blackstone (stake)
- UBS (major stake)
- Chrysler Building (90%, acquisito 2008)
- Hyatt Hotels
- Infrastrutture globali

### Mubadala: Il Braccio Strategico

| Metrica | Valore (2024) |
|---------|---------------|
| **Fondato** | 2002 (come ADIC), rebrand 2017 |
| **AuM** | $330 miliardi |
| **CEO** | [Khaldoon Al Mubarak](../docs/persons/khaldoon-al-mubarak.md) |
| **Investimenti 2024** | $29.2B (leader mondiale SWF) |
| **Deals 2019-2024** | 300+ |

**Portfolio Strategico:**

| Categoria | Aziende/Asset |
|-----------|---------------|
| **Semiconduttori** | [GlobalFoundries](../docs/company/globalfoundries.md) (75%), AMD (storico) |
| **Private Equity** | KKR, Silver Lake, SoftBank, Investcorp |
| **Tech** | G42, Anthropic, OpenAI (via MGX) |
| **Energia** | [Masdar](../docs/company/masdar.md), CEPSA |
| **Sport** | Ferrari (5%), City Football Group (via ADUG) |
| **Healthcare** | Cleveland Clinic Abu Dhabi |

### ADQ: Il Nuovo Campione
...
|---------|---------------|
| **Fondato** | 2006 |
| **Total Assets** | AED 1.47T (~$400B) |
| **Revenue** | AED 349.6B |
| **Net Profit** | AED 67.5B |
| **Paesi** | 85 |
...
|---------|-------|---------|
| [Emirates](../docs/company/emirates-airline.md) | 100% | Aviation |
| [DP World](../docs/company/dp-world.md) | 100% | Ports/Logistics |
...
## Sheikh Tahnoun: L'Uomo piu' Potente degli Emirati

[Sheikh Tahnoun bin Zayed](../docs/persons/sheikh-tahnoun-bin-zayed.md) e' il super-connettore del sistema UAE, controllando un impero da $1+ trilione:
...
| **Governo UAE** | National Security Advisor | - |
| **Mubadala** | Board | $330B |

### La Strategia Tahnoun
...
| **Chairman** | Tahnoun bin Zayed |
| **CEO** | Peng Xiao |
| **Investitori** | Microsoft ($1.5B, 2024), Silver Lake, Mubadala |
| **Focus** | AI, cloud, healthcare |

**Microsoft Partnership (Aprile 2024):**
- $1.5B investimento Microsoft
- Brad Smith entra nel board G42
- Azure come cloud platform
- G42 abbandona partnership cinesi (Huawei)
...
|--------------|--------|------|
| OpenAI | Partecipazione | Via tender shares |
...
Il progetto Stargate ($500B per infrastruttura AI USA) vede MGX come partner mentre PIF Saudi e' escluso:

| Aspetto | UAE (MGX) | Saudi (PIF) |
|---------|-----------|-------------|
| Stargate | Partner | **ESCLUSO** |
| OpenAI | Investor | No |
| Microsoft | Partner ($1.5B) | No |
| Abraham Accords | Si (2020) | No |
| China ties | Tagliati (2024) | Ancora presenti |
...
| **Fondato** | 1971 |
| **CEO** | Sultan Al Jaber |
| **Produzione** | ~4 mmboe/d |
| **Riserve** | 98 miliardi barili |
| **Ruolo Al Jaber** | Presidente COP28, Min. Industria |

### Masdar: La Transizione Energetica

| Metrica | Valore (2024) |
|---------|---------------|
| **Fondato** | 2006 |
| **Capacita'** | 51 GW (150% crescita in 2 anni) |
| **Azionisti** | Mubadala + ADNOC + TAQA |
| **Investimenti 2024** | $8B equity + $4.5B project finance |
| **Paesi** | 40+ |

**Progetti Notevoli:**
- Dogger Bank (UK, £11B, 50% stake)
- Terra-Gen Power (USA, 50% stake, 2024)
- London Array (UK)

### GlobalFoundries: I Semiconduttori

| Metrica | Valore |
|---------|--------|
| **Fondato** | 2009 (spin-off AMD) |
| **HQ** | Malta, New York |
...
|---------|-------|--------------|
| [Mohammed bin Zayed](../docs/persons/mohammed-bin-zayed.md) | Presidente UAE | Governo |
| [Mohammed bin Rashid](../docs/persons/mohammed-bin-rashid.md) | PM UAE, Ruler Dubai | ICD |
| [Tahnoun bin Zayed](../docs/persons/sheikh-tahnoun-bin-zayed.md) | NSA | ADIA, ADQ, G42, MGX, FAB |
| [Mansour bin Zayed](../docs/persons/mansour-bin-zayed.md) | Vice Presidente | EIA, Man City |
| [Abdullah bin Zayed](../docs/persons/abdullah-bin-zayed.md) | Min. Esteri | Governo |
...
### WEF Young Global Leaders (UAE)

| Persona | Anno | Note |
|---------|------|------|
| [Omar bin Sultan Al Olama](../docs/persons/omar-bin-sultan-al-olama.md) | - | Min. AI |
| [Sheikha Shamma bint Sultan](../docs/persons/sheikha-shamma-bint-sultan.md) | - | Sustainability |
| [Sheikh Maktoum bin Mohammed](../docs/persons/sheikh-maktoum-bin-mohammed.md) | - | Deputy Ruler Dubai |
...
|---------|--------|
| **Fondato** | 2013 |
| **Chairman** | [Khaldoon Al Mubarak](../docs/persons/khaldoon-al-mubarak.md) |
| **Owner** | ADUG (Sheikh Mansour) |
| **Valutazione** | $6B+ |
| **Club** | 13 (Man City, NYC FC, Melbourne, etc.) |

**Manchester City:**
- Acquisito 2008 da Sheikh Mansour
- 6 Premier League in 7 anni (2018-2024)
- Treble storico 2023 (PL + FA Cup + UCL)

### Formula 1 Abu Dhabi

- Yas Marina Circuit dal 2009
- Finale stagione F1
- Abu Dhabi Motorsports Management (Khaldoon Al Mubarak chairman)

### COP28 (2023)

- Ospitato a Dubai
- Presidente: Sultan Al Jaber (CEO ADNOC)
- Controversie: oil executive guida summit clima
...
UAE primo paese del Golfo a normalizzare con Israele:

| Aspetto | Dettaglio |
|---------|-----------|
| **Firma** | 15 Settembre 2020 |
| **Mediatore** | Trump Administration |
| **Conseguenze** | Trade $3B+/anno, tech partnerships |
| **Vantaggio** | Accesso preferenziale ecosistema tech USA |

### La Biforcazione UAE-Saudi

| Dimensione | UAE | Saudi |
|------------|-----|-------|
| **Strategia** | Tech/AI first | Sport/entertainment |
| **Stargate** | Dentro | Fuori |
| **Israele** | Normalizzato | No |
| **Approach** | Silenzioso, tecnocratico | Mediatico, MBS-centrico |
| **Soft power** | CFG, subtile | Newcastle, LIV Golf, FIFA 2034 |
...
SURPLUS FISCALE
      |
      +--> ADIA (preservazione, $1T)
      |
      +--> Mubadala (strategico, $330B)
      |
      +--> ADQ (domestico, $170B)
      |
      v
DIVERSIFICAZIONE
      ...
      +--> Tech/AI (G42, MGX)
      |
      +--> Rinnovabili (Masdar 51GW)
      |
      +--> Semiconduttori (GlobalFoundries)
```

### Concentrazione del Potere

Sheikh Tahnoun controlla piu' asset ($1.2T+) di qualsiasi altro individuo non-monarca al mondo:

| Persona | Asset Controllati | Note |
|---------|-------------------|------|
| **Tahnoun bin Zayed** | $1.2T+ | ADIA + ADQ + G42 + FAB |
| MBS (Saudi) | $1.15T | PIF |
| Xi Jinping | $3T+ (via CIC) | Ma controllo indiretto |

### Vantaggi Competitivi vs Saudi

1. **Dimensione** - Piu' piccoli = piu' agili
2. **Governance** - Meno visibili, piu' tecnocratici
3. **Geopolitica** - Abraham Accords = accesso USA/Israele
4. **Reputazione** - No equivalente Khashoggi
5. **Tech focus** - G42/MGX vs sport saudita
...
|------|---------|-----------|
| **Diritti umani** | Sempre | Repressione dissidenti, Ahmed Mansoor |
| **Yemen** | 2015-2020 | Partecipazione coalizione saudita |
| **G42-Cina** | 2020-2024 | Legami con Huawei, risolti con deal Microsoft |
...
### Primarie
- [ADIA Official](https://www.adia.ae/)
- [Mubadala Official](https://www.mubadala.com/)
