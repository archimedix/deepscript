Mappa del Potere - Belgio
  ...
  | European Round Table (ERT) | Lobby CEO europei          |
  ...
  | Deme Group      | Dragaggio/Offshore          |

  Figure Chiave da Investigare
  ...
  | Forum                | Connessione Belgio                      |
  |----------------------|-----------------------------------------|
  | Bilderberg           | Davignon chairman, spesso meeting in BE |
  | Trilaterale          | Van Rompuy membro                       |
  | WEF                  | Molti leader belgi YGL                  |
  | [v] European Round Table | CEO belgi fondatori                     |

  Temi da Approfondire

  1. Revolving door Bruxelles: Commissari EU → lobby → corporate
  2. Lobby farmaceutico: EFPIA sede a Bruxelles
  3. SWIFT e geopolitica: Controllo infrastruttura finanziaria
  4. Monarchia e business: Legami corona-industria
  5. Congo connection: Eredità coloniale, risorse minerarie
  6. AB InBev/3G Capital: Modello brasiliano-belga